...
n_sizes = [256, 1024, 2304, 4096, 6400, 9216, 12544, 16384, 20736, 25600, 30976, 36864, 43264, 50176, 57600, 65536]
reps = 1000
...
def bench():
    with keep.running(): # Prevent sleep during benchmarking
        print("\n--- Starting Benchmarking (Cython Comparison) ---\n")
        # Set up DF
        ...
        for n in n_sizes:
            ...
            # Save results
            df.to_csv("benchmarking_results_gabp_cython_comparison.csv")
            print("Saved benchmarking results to benchmarking_results_gabp_cython_comparison.csv")
